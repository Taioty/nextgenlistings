...
class Kirki_Customize_Color_Control extends WP_Customize_Control {
	...
	public function __construct( $manager, $id, $args = array() ) {
		$this->statuses = array( '' => __( 'Default', 'bootframe-core' ) );
	...
	public function render_content() {
		...
		<label>
			...
			<div class="customize-control-content">
				<input class="color-picker-hex kirki-color-picker" type="text" maxlength="7" placeholder="<?php esc_attr_e( 'Hex Value', 'bootframe-core' ); ?>"<?php echo $default_attr; ?> <?php echo $setting_attr; ?> <?php echo $framework_var; ?>/>
			</div>
		</label>
		<?php
