...
class Kirki_Fonts {
	...
	public static function get_google_font_subsets() {
		...
		return array(
			'all'          => __( 'All', 'bootframe-core' ),
			'cyrillic'     => __( 'Cyrillic', 'bootframe-core' ),
			'cyrillic-ext' => __( 'Cyrillic Extended', 'bootframe-core' ),
			'devanagari'   => __( 'Devanagari', 'bootframe-core' ),
			'greek'        => __( 'Greek', 'bootframe-core' ),
			'greek-ext'    => __( 'Greek Extended', 'bootframe-core' ),
			'khmer'        => __( 'Khmer', 'bootframe-core' ),
			'latin'        => __( 'Latin', 'bootframe-core' ),
			'latin-ext'    => __( 'Latin Extended', 'bootframe-core' ),
			'vietnamese'   => __( 'Vietnamese', 'bootframe-core' ),
		);
	...
	public static function get_standard_fonts() {
		...
		return array(
			'serif' => array(
				'label' => _x( 'Serif', 'font style', 'bootframe-core' ),
				'stack' => 'Georgia,Times,"Times New Roman",serif'
			),
			'sans-serif' => array(
				'label' => _x( 'Sans Serif', 'font style', 'bootframe-core' ),
				'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
			),
			'monospace' => array(
				'label' => _x( 'Monospaced', 'font style', 'bootframe-core' ),
