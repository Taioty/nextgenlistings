...
//add section: logo
        ...
        if(class_exists( 'WooCommerce' )){
            ...
            $wp_customize->add_section('smartlib_wocommerce_section', array(
        ...
        $wp_customize->add_panel( 'smartlib_slider_frontpage', array (
            'title'                 => __( 'Front Page Slider', 'bootframe-core' ),
            'description'           => __( 'Customize the slider. BootFrame Core includes 3 slides', 'bootframe-core' ),
            'priority'              => 8
        ) );

        $wp_customize->add_section('smartlib_frontpage_slide_1', array(
            'title' => __('Slide #1', 'bootframe-core'),
            'priority' => 20,
            'panel'          => 'smartlib_slider_frontpage',
        ));

        $wp_customize->add_section('smartlib_frontpage_slide_2', array(
            'title' => __('Slide #2', 'bootframe-core'),
            'priority' => 21,
            'panel'          => 'smartlib_slider_frontpage',
        ));

        $wp_customize->add_section('smartlib_frontpage_slide_3', array(
            'title' => __('Slide #3', 'bootframe-core'),
            'priority' => 22,
            'panel'          => 'smartlib_slider_frontpage',
        ));

        $wp_customize->add_section('smartlib_frontpage_more_slides', array(
            'title' => __('Add more slides', 'bootframe-core'),
            'priority' => 23,
            'panel'          => 'smartlib_slider_frontpage',
        ));
    }
