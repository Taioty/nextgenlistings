            ...
            <div class="smartadapt-form-proversion-info-outer">
                ...
                <div class="smartadapt-form-block">
                    <div class="smartadapt-form-line">
                        <label for="cat_extra_data_0" class="smartadapt-radio-label"><?php _e( 'Default Settings', 'bootframe-core' ); ?></label><input type="radio" name="cat_extra_data[smartlib_layout_category]" id="cat_extra_data_0" style="float: left; width: auto" value="0" <?php echo $cat_extra_data['smartlib_layout_category'] == 0 ? 'checked=checked' : ''; ?>><br />
                    </div>
                    <div class="smartadapt-form-line">
                        <label for="cat_extra_data_1 class="smartadapt-radio-label"><?php _e( 'No Sidebar', 'bootframe-core' ); ?></label><input type="radio" name="cat_extra_data[smartlib_layout_category]" id="cat_extra_data_1" style="float: left; width: auto" value="1" <?php echo $cat_extra_data['smartlib_layout_category'] == 1 ? 'checked=checked' : ''; ?>><br />
                    </div>
