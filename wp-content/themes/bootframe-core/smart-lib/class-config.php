...
class Smartlib_Config
{
    ...
    public $theme_prefix = 'bootframe-core';
    ...
    public $project_sidebars = array(
        ...
        'sidebar-frontpage_features' => array(
            'name' => 'Front Page Features',
            'description' => 'Appears Front Page Features',
    ...
    public $assign_context_sidebar = array(
        ...
        'woocommerce_default' => array('<ul class="smartlib-layout-list">', 'shop_sidebar', '</ul>'),
        'woocommerce_single' => array('<ul class="smartlib-layout-list">', 'shop_single_sidebar', '</ul>'),
