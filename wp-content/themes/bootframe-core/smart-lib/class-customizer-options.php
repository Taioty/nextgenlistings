    ...
    */
        ...
        */
        ...
        $this->options['smartlib_general_font_family_default'] = array(
            ...
            'default' => self::$default_config->smartlib_fonts['smartlib_general_font_family_default'],
            'priority' => 1,
            'choices' => Kirki_Fonts::get_font_choices()
        );
    ...
    for($i=1; $i <=3; $i++){
        ...
        $this->options['smartlib_slide_button_text_1_'.$i] = array(
            'type' => 'text',
            'setting' => 'smartlib_slide_button_text_1_'.$i,
            'label' => __('Button #1 Text', 'bootframe-core'),
            'section' => 'smartlib_frontpage_slide_'.$i,
        ...
        $this->options['smartlib_slide_button_url_1_'.$i] = array(
            'type' => 'text',
            'setting' => 'smartlib_slide_button_url_1_'.$i,
            'label' => __('Button #1 URL', 'bootframe-core'),
            'section' => 'smartlib_frontpage_slide_'.$i,
            'priority' => 4,
        );

        $this->options['smartlib_slide_button_text_2_'.$i] = array(
            'type' => 'text',
            'setting' => 'smartlib_slide_button_text_2_'.$i,
            'label' => __('Button #2 Text', 'bootframe-core'),
            'section' => 'smartlib_frontpage_slide_'.$i,
            'description' => __('The text for the button / leave blank to hide', 'bootframe-core'),
        ...
        $this->options['smartlib_slide_button_url_2_'.$i] = array(
            'type' => 'text',
            'setting' => 'smartlib_slide_button_url_2_'.$i,
            'label' => __('Button #2 URL', 'bootframe-core'),
            'section' => 'smartlib_frontpage_slide_'.$i,
            'priority' => 6,
        );
    }

        $this->options['smartlib_frontapge_features_header'] = array(
            'type' => 'text',
            'setting' => 'smartlib_frontapge_features_header',
            'label' => __('Features Header', 'bootframe-core'),
            'section' => 'static_front_page',
            'default' => __('Our Services', 'bootframe-core'),
            'priority' => 16,
        );

        $this->options['smartlib_frontapge_lastnews_header'] = array(
            'type' => 'text',
            'setting' => 'smartlib_frontapge_lastnews_header',
            'label' => __('Last News Header', 'bootframe-core'),
            'section' => 'static_front_page',
            'default' => __('Latest News', 'bootframe-core'),
            'priority' => 17,
        );
