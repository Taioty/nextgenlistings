...
function smartlib_activation_display()
{
    ...
    <div class="wrap">
        ...
        <div class="welcome-panel">
            ...
            <p class="about-description" style="padding-top: 20px"><a href="http://rocksite.pro/bootframe/boot-frame-more-info-info-page/" target="_blank">BootFrame Premium</a> <?php _e('adds exciting new customization features to the Customizer and other powerful customization tools like shortcodes or layout options.', 'bootframe-core') ?></p>
            ...
            <p><a href="http://rocksite.pro/bootframe/boot-frame-more-info-info-page/" class="button button-primary button-hero" target="_blank"><?php _e('More Info', 'bootframe-core') ?> &raquo;</a></p></p>
...
function smartlib_theme_register_required_plugins()
{
     ...
     */
    $config = array(
        'id' => 'bootframe-core',                 // Unique ID for hashing notices for multiple instances of TGMPA.
...
function smartadapt_add_theme_widgets($old_theme, $WP_theme = null) {
    ...
    for ($i = 1; $i <= 4; $i++) {
        ...
        smartlib_pre_set_widget('sidebar-frontpage_features', 'smartlib_extend_content',
            array(
                'title' => __('Service', 'bootframe-core'),
                'box_image' => get_template_directory_uri() . '/assets/img/widget/download.png',
                'box_text' => 'Lorem ipsum dolor sit amet, consectetur adipisicing elit',
                'box_external_link' => '#',
